...
```CLI
$ helm del brp-dev  --purge --kubeconfig="api/helm/kubeconfig.yaml --namespace=dev" 
$ helm del brp-stag --purge --kubeconfig="api/helm/kubeconfig.yaml --namespace=stag" 
$ helm del brp-prod --purge --kubeconfig="api/helm/kubeconfig.yaml --namespace=prod" 
```
